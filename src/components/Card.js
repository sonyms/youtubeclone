...
const Card = ({type}) => {
  return (
    <Link to="/video/1" style={{textDecoration: 'none'}}>
        <Container type={type}>
            <Image type={type} src="https://i.ytimg.com/vi/RkWpJ4XUHuw/hqdefault.jpg?sqp=-oaymwEbCKgBEF5IVfKriqkDDggBFQAAiEIYAXABwAEG&rs=AOn4CLAx8iHZ_K8IskCqNh5zDxwfHf17nQ"/>
            <Details type={type}>
